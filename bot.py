...
Farm30 = ["lost1", "lost2", "lost3", "lost4", "lost5", "lost6", "lost7", "lost8", "lost9"]
Farm32 = ["piusrock1", "piusrock2", "piusrock3", "piusrock4", "piusrock5", "piusrock6", "piusrock7", "piusrock8", "piusrock9"]
Farm34 = ["or1", "or2", "or3", "or4", "or5", "or6", "or7", "or8"]
...
def Farming(Level):
    ...
    leftClick(.5)
    nrChar = len(Level)
    while (LevelCount < nrChar):
        mousePos(Cord.a_search)
        leftClick(.5)
        SendKeys.SendKeys(Level[LevelCount])
        mousePos(Cord.a_searchok)
        leftClick(5)
        mousePos(Cord.a_fight)
        leftClick(3)
        mousePos(Cord.fight_skip)
        ...
        mousePos(Cord.centerClick)
        leftClick(2)
        if (LevelCount < (nrChar-1)):
            mousePos(Cord.a_search)
            leftClick(.5)        
            SendKeys.SendKeys('''{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}{BS}''')        
...
def main():                
    while True:                
        ...
        #if ((hourtime==0 or hourtime==2 or hourtime==4 or hourtime==6 or hourtime==8 or hourtime==10 or hourtime==12 or hourtime==14 or hourtime==16 or hourtime==18 or hourtime==20 or hourtime==22 or hourtime==24)and minutetstartGame()
        count = 0
        count2 = 0
        count3 = 0
        count4 = 0        
        ...
        Login_Start(maincount)            
        #Mining()            
        Farming(Farm38)                
        time.sleep(20)
        mousePos(Cord.failedConnect)
        leftClick(.2)
        LogOff() 
        ...
        while (count < 5):
            ...
            #print "finish of first part: "
            #print count
                         
        
        while (count2 < 5):
            Login_Start((count2+6))
            count2 = count2 + 1
            #Mining()            
            #Fighting()
            Farming(Farm32)                
            ...
            leftClick(.2)
            LogOff()
            #print "finish of second part: "
            #print count2
            
            
            
        while (count3 < 5):
            Login_Start((count3+11))
            count3 = count3 + 1
            #Mining()            
            #Fighting()
            Farming(Farm28)                
