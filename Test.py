...
Farm26 = ["gungrave1", "gungrave2", "gungrave3", "gungrave4", "gungrave5", "gungrave6"]
Farm38 = ["evo1", "evo2", "evo3", "evo4", "evo5", "evo6"]
...
def main():
    ...
    while True:                
        ...
        #if ((hourtime==0 or hourtime==2 or hourtime==4 or hourtime==6 or hourtime==8 or hourtime==10 or hourtime==12 or hourtime==14 or hourtime==16 or hourtime==18 or hourtime==20 or hourtime==22 or hourtime==24)and minutetime==0):
        startGame()
        count = 0
        count2 = 0
        maincount = 0        
